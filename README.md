...
The VM can currently load huge Scratch projects in under 1 second (result given when testing Linux On Scratch). Unfortunately you can't actually do anything meaningful with the VM since it cannot yet execute blocks, though that *is* coming soon.
